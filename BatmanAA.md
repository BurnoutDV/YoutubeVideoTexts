## Batman Arkham Asylum (2021 LP)

* tags = `batman,warner,lets play,ingame,joker,harley,quinn,psychater,harvey dent,boles,croc,blackgate,sharp,eddie barlow,zsasz,gretchen,riddler,two-face,kellerman,dr. chen,sarah cassidy,Dr. Young,Bruce Wayne,Batgirl,batboy,batmobil,film,dark knight,irrenhaus,playthrough,speedrun,hd,full-hd,1080p,60fps,playstation,pc,commentary,story`

##### #1

* Titel: `Batman Arkham Asylum - #1 - Einlieferung [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Ich habe Batman Arkham Asylum bereits 2014 einmal gespielt, das Spiel selbst kam übrigens 2009 raus und ich habe es damals irgendwie verpasst. Als ich es das erste Mal spielte geschah dies im Rahmen eines damaligen Projektes das sich "Lets Sprung" nannte. Spiele die ich zwar gespielt habe aber nicht regelmäßig aufnahm. Das ganze Konzept war bereits zum Scheitern verurteilt weil ich eigentlich Lets Plays nur mache um Spiele tatsächlich durchzuspielen. Wenn jetzt auf einmal der Druck weg ist wirklich etwas durchzuspielen kann man sich das Ergebnis schon vorstellen. Wie dem aber auch sei, ich habe die ersten sieben Episoden betitelt ohne mir die Namen der 2014er Episoden anzuschauen. Erkenntnis, ich habe damals ziemlich gleich gedacht. Übrigens, kleiner Funfact, ich habe die alten Episoden meines unvollständigen Lets Plays auf "Nicht gelistet" gestellt, man kann sie aber immer noch mit der Playlist angucken..wenn man das unbedingt will.
...
* Titel: `Batman Arkham Asylum - #2 - Personalkartei [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Ich entdecke heute das ich sowas wie eine Kartei aller Verbrecher und Personen habe die Batman so trifft. Das sind wirklich nicht immer Personen die in der Zeile "Beruf" "hauptberuflicher Verbrecher" zu stehen haben. Übrigens eine ziemlich unglaubwürdige Beschreibung. Ich bin mir ziemlich sicher das die meisten hochkarätigeren Verbrecher irgendeine Art von offiziellen Job ausgeübt haben oder eine Art von Ausbildung genossen haben. So etwas hilft bei der Ausübung von Verbrechen. Manche Leute sind auch einfach nur Psychos die schon immer ziemlich verdorben waren oder einfach nie soweit gekommen sind das es einen normalen Job gab, und doch, niemand ist hauptberuflich Verbrecher. Das kann man ja auch nicht bei der Steuer angeben. Stattdessen ist ist man im Zweifel einfach nur "arbeitslos" bzw. neu-Deutsch "arbeitssuchend". Was auch immer der Unterschied ist. Die Grundannahme ist auf jeden Fall das jeder Mensch ganz dringend Arbeit sucht und wenn es keine hat dann sucht man offensichtlich welche. Ist ja klar oder? Wie dem auch sei, heute lese ich einfach mal alle Einträge vor die wir schon haben damit ich nicht in Verzug gerate.
...
* Titel: `Batman Arkham Asylum - #3 - Detektivarbeit [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Batman ist enorm gut darin sich selbst zu beweihräuchern und jeden zu erzählen was für eine coole Ausbildung er genossen hat. Das Ganze ist ein wenig interessant wenn man sich die Vorbildwirkung anschaut. Während ich darüber nachdenke wird mir schon wieder klar das es ein antikapitalistischer Rant wird, aber so sei es. Batman zeichnet aus das er unter der Maske eigentlich ein normaler Kerl ist. Das ist immer noch ein Mensch der keine besonderen Fähigkeiten hat. Superman wird halt so geboren wie er ist und damit hat sich das. Seine eigenen Fähigkeit sind halt schon da. Unsere Fledermaus hat hart für seine Fähigkeit trainiert, hat die Hilfe von Trainern in Anspruch genommen und hat ziemlich viel durch eigenen Ehrgeiz erreicht. Das wollen wir mal nicht klein reden. Auf der anderen Seite konnte er das nur weil er tödlich reich war. Das typische Kind das sich die Eskapaden von Batman ansieht hat nicht einmal in Ansatz die Chancen wie unser Rächer. Die ganze juristische Geschichte lassen wir einfach mal außer Acht. Und dennoch, Gotham ist ein Loch ohne Gleichen, ein Moloch an Amoral und Verdorbenheit die fast schon biblische Ausmaße annimmt. Also halt New York in den 70er Jahren. Wie dem aber auch sei, Wayne Enterprise scheint lächerlich viel Geld zur Verfügung zu haben. Könnte es nicht vielleicht sein das man die Probleme der Stadt wesentlich eleganter lösen könnte. Klar, ein verkleideter Rächer ist natürlich ganz cool, aber schrecklich ineffizient. Andererseits würde man sich wahrscheinlich eingestehen das das ganze System grotesk abscheulich ist wenn man die Wurzel aller Problem angreifen will. Und das wäre ja quasi Kommunismus. Batman enthält ganz schön viel Gesellschaftskritik wenn man so darüber nachdenkt. Oder eben nicht aber die Abwesenheit solcher. Wie dem auch sei, weil reiche Sack übel viel Knete hat konnte er sich drei oder vier bezahlte Videos zum Thema Spurenlesen angucken und das Ergebnis der Ausbildung sehen wir heute.
...
* Titel: `Batman Arkham Asylum - #4 - Fahrstuhlschacht [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Ich hatte den Eindruck das wir eigentlich gar nicht so tief unter der Erde sind aber ich habe mich wohl getäuscht. Generell und überhaupt sind mir die genauen Dimensionen der Anlage nicht so richtig bekannt, generell und überhaupt wundere ich mich aber. Zwischenzeitlich hieß es das es sich hier um eine modernste Anlage handelt die in den Ruinen des alten Arkham Manor gebaut wurde. Davon sehe ich ehrlich gesagt nicht viel. Selbst wenn man alte Teile vergessen hat oder hier und dort noch irgendwo alte Möbel rumstehen die beim Einrichten  einfach nur weg geräumt wurden würde das ja passen. An jeder Ecke stehen aber Kameras, Fahrstuhlschächte wurden installiert und so weiter und sofort. ABER, anscheinend hatte Arkham Manor das ganze Zeug schon vorher, weil es sieht aus wie sau! Alles ist dreckig, uralt und sowieso kaputt. Es kann mir doch niemand erzählen das die Anlage erst seit einigen Jahren existiert. Der meiste Müll sieht so aus als wäre er direkt aus dem Mittelalter importiert worden. Mal ernsthaft, wo sind wir den hier?! Auf jeden Fall nicht im Land der funktionierenden Fahrstühle, soviel ist klar.
...
* Titel: `Batman Arkham Asylum - #5 - das Batmobil [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Wir sind ja nicht zur Fuß in die Irrenanstalt von Arkham gekommen. Generell und überhaupt halte ich das gesamte Konzept einer Irrenanstalt innerhalb der Grenzen von Arkham übrigens für eine absolut fatale Geschichte. Offensichtlich haben verschiedene Verbrecher trotz oder grade wegen ihres Geisteszustandes ein enormes Netzwerk von Verbündeten in und um der Stadt herum aufgebaut. Warum genau also versucht man die Leute genau dort zu behandeln wo sie am stärksten sind und unter Umständen einfach Hilfe erhalten könnten? Oder wie heute passiert, sogar in der Lage sind koordinierte Taten durchzuführen. Wäre es nicht irgendwie schlauer wir würden eine Person wie den Joker in einem Gefängnis irgendwo in Kalifornien oder Alaska abladen? Die  eventuelle Behandlung, wie erfolgreich sie auch sein könnte, kann man ja quasi überall durchführen. Auf der anderen Seite, die ökonomischste Entscheidung, wenn man ein gesetzloser Rächer sein, will wäre wahrscheinlich eh wesentlich tödlicher. Generell erscheint mir die Eliteausbildung einer Person ein wenig übertrieben wenn man bedenkt das man für das Gleiche, wenn nicht sogar für weniger Geld eine private Söldnerarmee mit taktischer Aufklärung anheuern könnte, die Stück für Stück das bestehende Problem endgültig beendet. Der Cleanerservice hinten dran kann dann auch nicht mehr die Welt kosten. Wahrscheinlich wesentlich weniger als ein teures Elitefahrzeug wie das Batmobil. Wie dem auch sei, jetzt haben wir den Boliden und müssen ihn scheinbar auch retten, weil Batman nicht will das irgendwelche Geiseln verletzt werden. Ich sehe da ein Muster im Verhalten der Fledermaus. Stellt sich die Frage wie viele Menschen bereits sterben mussten weil er Mitleid mit irgendwelchen zufälligen Einzelpersonen gezeigt hat die ihm selber nahe standen und er nicht in der Lage war die richtige Konsequenz zu ziehen. Erstaunlich für einen angeblich so begabten Detektiv.
...
* Titel: `Batman Arkham Asylum - #6 - Tabakspuren [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Irgendwie sind wir ziemlich gut darin andauernd irgendwelche Leute zu verlieren, heute zum Beispiel Officer Gordon, der ist eigentlich Commissioner was sowas wie eine lokaler Polizeichef ist wenn ich das recht  verstehe, also eigentlich ein ziemlich hohes Tier über den nicht mehr all zu viele stehen sollte, eigentlich nur noch ein Komitee und eventuell der Bürgermeister obwohl ich mich immer noch schwer tue zu verstehen was genau ein Bürgermeister jetzt im Genauen tut. In Gotham scheint es sich dabei um eine wichtige Position zu handeln. Eine Position die offensichtlich von einem quasi Diktator gefüllt wird, bei einer Stadt von der Größe wie Gotham erscheint es mir ziemlich gefährlich zu sein eine einzelne Person auf den Posten zu stellen. Der Umfang der Aufgabe scheint besser für eine Art Mini-Parlament oder Beraterkreis geeignet zu sein. Wie dem aber auch sei, wir vermissen Gordon doch sehr also machen wir uns auf seine Spur zu verfolgen. Als wertvolle Geisel hat er immerhin einige Hoffnung die ganze Operation hier zu überleben. Vielleicht.
...
* Titel: `Batman Arkham Asylum - #7 - das Medizingebäude [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Die medizinische Versorgung in Gotham scheint mir ein typische amerikanisches Niveau zu haben, excellent wenn man über eine Menge Geld verfügt und defacto inexistent wenn man eben keines hat. Das würde auch die enorm hohe Kriminalitätsrate in der Stadt erklären und warum die Klinik die wir schon in einigen Teilen besichtigen durften so aussieht wie sie aussieht. Alles ist irgendwie verfallen und angeblich handelt es sich um eine hoch moderne Einrichtung. Ich erfahre später das es sich erst um das Gotham-Anwesen handelte, dann eine Irrenanstalt geworden ist und erst in jüngster Zeit quasi auf die neusten Entwicklungen umgerüstet wurde. Das erklärt zumindest das altertümliche Equipment das wir überall sehen aber heute betreten wir dann auch das Medizingebäude. Der Ort an dem ich klinische Reinheit erwarten würde. Was wir finden ist natürlich weit weg davon. Es sieht eher nach Folterkammer aus. Und der Zustand der Patienten lässt mich vermuten das das nicht unbedingt weiter weg von der Realität ist. Immerhin retten wir heute ein paar der anwesenden Ärzte. Das ist dann aber auch schon alles. Toll.
...
* Titel: `Batman Arkham Asylum - #8 - medizinisches Personal [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Ich bin mir nicht ganz sicher ob auch nur eine Person in den Anlange des Asylums über eine Approbation verfügt oder ob der einzige Unterschied zwischen den Leuten hinter den Gittern und davor darin liegt das die Leute offiziell verurteilt wurden. Allem Anschein nach sind alle Handlungen in der Anlage höchst unethisch und alles sollte sofort abgeschlossen werden, wie irgendjemand mit einem Funken Integrität glauben kann das das Arkham Asylum eine gute Idee ist ist mir schleierhaft. Von Rechtswegen gehört die Anlage abgeschlossen. Definitiv. Es könnte natürlich auch sein das das ein wenig besser ausgebildete Personal einfach Nachts nicht anwesend, generell ist es eigentlich ein Wunder das überhaupt soviel nicht  Sicherheitspersonal sich in der Anlage aufhält. Oder besser gesagt aufhielt, die meisten sind ja mittlerweile tot.

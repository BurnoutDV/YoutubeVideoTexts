...
* Beschreibung:
  ...
  0:00 - Gameplay
  13:55 - Biografie: Varl
  14:46 - Gameplay
  20:47 - Biografie: Elisabet Sobeck
  23:47 - Gameplay
...
* Beschreibung:
  ...
  0:00 - Gameplay
  9:20 - Text: Handelsabkommen
  10:03 - Gameplay
  10:30 - Biografie: Travis Tate
  11:09 - Gameplay
  16:36 - Biografie: HADES
  17:56 - Gameplay
...
* Beschreibung:
  ...
  0:00 - Gameplay
  8:03 - Biografie: Ted Faro
  10:10 - Gameplay
  11:45 - Text: Was machen wir mit Dalgaard?
  12:16 - Gameplay
...
* Titel: `Horizon Forbidden West - #8 - Übersprengung [Let's Play; ger; Blind]`

* Beschreibung:

  ```markdown
  Die große Moria Szene kommt übrigens noch, in einigen vielen Episoden, aber es wäre eine günstige Situation die guten alten Mittelerde Zwerge schon einmal aufzuwärmen, auch wenn es technisch gesehen noch gar nicht so weit ist. Also, die Sachlage ist die das es hier eine Mine gibt und man scheinbar ein wenig unvorsichtig mit dem Sprengstoff war. Generell und überhaupt bin ich übrigens total überrascht das sich eigentlich überhaupt noch Ressourcen unter der Erde finden. Ich kann mich nicht erinnern das irgendwelche Roboter erwähnt wurden die Erze wieder in die Erde eingraben. Oder gibt es irgendwo in Amerika noch Flöße die in modernen Tagen nicht geerntet wurden? Sowas kann durchaus sein, die deutschen Eisenvorräte sind zum Beispiel auch noch da, die Salzgitter AG beispielsweise importiert ihr Roheisen lieber, einfach weil man es besser verarbeiten kann.
